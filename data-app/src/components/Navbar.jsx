...
const Navbar = ({ handleScroll, refs }) => {
    ...
    return (
        <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto p-4 text-white">
            <h1 className="w-full text-3xl font-bold text-[#1cc9da]">DRAFT.</h1>
            <ul className="hidden md:flex">
                <li className='p-4 cursor-pointer hover:text-[#1cc9da] font-bold uppercase' onClick={() => scrollToSection(refs.heroRef)}>Úvod</li>
            ...
            <div className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000400] ease-in-out duration-500' : 'fixed left-[-100%]'}>
                <h1 className="w-full text-3xl font-bold text-[#1cc9da] m-8">DRAFT.</h1>
                <ul className='uppercase p-4'>
                    <li className='p-4 border-b border-gray-600 cursor-pointer hover:text-[#1cc9da]' onClick={() => scrollToSection(refs.heroRef)}>Úvod</li>
